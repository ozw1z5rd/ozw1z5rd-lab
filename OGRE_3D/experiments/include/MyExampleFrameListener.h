...
extern Ogre::SceneNode* rotating_head;
extern Ogre::SceneNode* rotating_head2;

// head rotation params

Ogre::Radian mHeadRotx, mHeadRotY,  mHeadRotz;
Ogre::Radian mHead2Rotx, mHead2RotY, mHead2Rotz;
...
protected:
	...
	{
		static String currFps =  "Attuale FPS: ";
		static String avgFps =   "medio   FPS: ";
		static String bestFps =  "migliore FPS: ";
		static String worstFps = "peggiore FPS: ";
        ...
        //
		// manca la parte che inzializza .... e manca OgreCore.zip nelle risorse
		//
...
public:
	...
	MyExampleFrameListener(RenderWindow* win, Camera* cam, bool bufferedKeys = false, bool bufferedMouse = false,
		...
		mInputManager(0), mMouse(0), mKeyboard(0), mJoy(0)
	{
        ...
        mHeadRotx, mHeadRotY,  mHeadRotz;
        mHead2Rotx, mHead2RotY, mHead2Rotz;
...
// - - - - - -
        ...
        if ( mKeyboard->isKeyDown( OIS::KC_0 ) ) {
            mHeadRotx = mHeadRotY = mHeadRotz = Radian( 0 );
            mHead2Rotx = mHead2RotY = mHead2Rotz = Radian( 0 );
        }
...
//
// custom scene updater
//
// Ogre::Radian( 1 * evt.timeSinceLastFrame )
//
    virtual void updateScene( )
    {
        rotating_head->yaw( mHeadRotx );
		rotating_head->pitch( mHeadRotY );
		rotating_head->roll( mHeadRotz );

        rotating_head2->yaw( mHead2Rotx );
		rotating_head2->pitch( mHead2RotY );
		rotating_head2->roll( mHead2Rotz );
    }
	...
	bool frameRenderingQueued(const FrameEvent& evt)
	{
		...
		if (mCurrentSpeed < 0.0)
			mCurrentSpeed = 0.0;
//
// punta dal'origine, ruota, espande in base al tempo ed alla velocità corrente.
//
		mTranslateVector *= mCurrentSpeed;

        //std::cout << mCurrentSpeed << "\n";
